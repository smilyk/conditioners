...
public class ExceptionResponse {
    ...
    public static class ResponseBuilder {
        ...
        public conditioner.exceptions.ExceptionResponse get() {
            return new conditioner.exceptions.ExceptionResponse(errorCode, errorMessage, timestamp, stackTrace, errors, params);
        }
